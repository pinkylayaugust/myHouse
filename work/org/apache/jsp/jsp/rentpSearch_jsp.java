...
public final class rentpSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
System.out.println("Rent Price is"+rpr);
...
Statement stmt=null;
  try{
   ...
   String strname="SELECT * FROM house where rentprice='"+rpr+"'"; 
