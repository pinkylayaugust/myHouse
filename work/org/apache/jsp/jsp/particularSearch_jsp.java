...
public final class particularSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String pcu=new String(request.getParameter("pc").getBytes("ISO-8859-1"),"UTF-8");
System.out.println("Particular is"+pcu);
...
Statement stmt=null;
  try{
   ...
   String strname="SELECT * FROM house where particular='"+pcu+"'"; 
