...
public final class outputdatesearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String opdt=request.getParameter("opd");
System.out.println("Output Date is"+opdt);
...
Statement stmt=null;
  try{
   ...
   String strname="SELECT * FROM house where outputdate='"+opdt+"'"; 
