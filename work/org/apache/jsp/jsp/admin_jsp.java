...
Statement stmt=null;
  try{
   ...
   String strhouse="SELECT * FROM house"; 
   ...
   while (rs.next()) 
   {
	   ...
	   out.println("<td><a style='text-align:right top;' href='/myHouse/jsp/edit.jsp?id="+i+"'><img src='/myHouse/image/edit.jpg' width=30px height=30px></a></td>");
	   System.out.println("Edit Success");
	   out.println("<td><a style='text-align:right top;' href='/myHouse/jsp/delete.jsp?id="+i+"'><img src='/myHouse/image/delete.jpg' width=30px height=30px></a></td>");
   ...
   out.println("</div>"); 
      ...
      out.write("\r\n");
      out.write("<br><h2>\r\n");
      out.write("Data ထပ္မံျဖည့္သြင္းလိုပါက  insert button ကိုနွိပ္ျပီး ထည့္သြင္းနိုင္ပါသည္။<br>\r\n");
      out.write("<form action=\"/myHouse/jsp/insert.jsp\" name=\"ins\" method=\"get\">\r\n");
