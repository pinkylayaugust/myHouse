...
public final class inputdatesearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String ipdt=request.getParameter("ipd");
System.out.println("Type is"+ipdt);
...
Statement stmt=null;
  try{
   ...
   String strname="SELECT * FROM house where inputdate='"+ipdt+"'"; 
