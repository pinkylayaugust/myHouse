...
public final class typeSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String tp=new String(request.getParameter("tt").getBytes("ISO-8859-1"),"UTF-8");
...
Statement stmt=null;
  try{
   ...
   String strname="SELECT * FROM house where type='"+tp+"'"; 
