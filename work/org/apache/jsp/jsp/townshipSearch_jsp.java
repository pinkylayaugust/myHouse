...
public final class townshipSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String tsh=new String(request.getParameter("ts").getBytes("ISO-8859-1"),"UTF-8");
System.out.println("Township is"+tsh);
...
Statement stmt=null;
  try{
   ...
   String strname="SELECT * FROM house where township='"+tsh+"'"; 
