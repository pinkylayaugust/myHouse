...
<div class="footer">
<br>
<h2>လူၾကိီးမင္းရွာေဖြလိုေသာTownshipကို ရိုက္နွိပ္ျပီးရွာေဖြနုိင္ပါသည္။</h2>
<form action="/myHouse/jsp/townshipSearch.jsp"  name="ss" method="get" accept-charset="UTF-8" enctype="multipart/form-data">
<% request.setCharacterEncoding("UTF-8"); %>
<input style='font-family:Zawgyi-one;' type="text" name="ts"><br>
