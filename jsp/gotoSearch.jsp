...
<div class="footer">
<br>
<h2>လူၾကိီးမင္းရွာေဖြလိုေသာနာမည္ကို ရိုက္နွိပ္ျပီးရွာေဖြနုိင္ပါသည္။</h2>
<form action="/myHouse/jsp/nameSearch.jsp"  name="ss" method="get" accept-charset="UTF-8" enctype="multipart/form-data">
<% request.setCharacterEncoding("UTF-8"); %>
<input style='font-family:Zawgyi-one;' type="text" name="nn"><br>
