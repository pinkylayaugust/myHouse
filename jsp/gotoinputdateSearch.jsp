...
<div class="footer">
<br>
<h2>လူၾကိီးမင္းရွာေဖြလိုေသာစာရင္းသိရွိလိုပါက input date ကို  ရိုက္နွိပ္ျပီးရွာေဖြနုိင္ပါသည္။eg. day/month/year</h2>
<form action="/myHouse/jsp/inputdatesearch.jsp"  name="ipdate" method="get">
