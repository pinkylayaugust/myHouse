...
<div class="footer">
<br>
<h2>လူၾကိီးမင္းရွာေဖြလိုေသာစာရင္းသိရွိလိုပါက output date ကို  ရိုက္နွိပ္ျပီးရွာေဖြနုိင္ပါသည္။eg. day/month/year</h2>
<form action="/myHouse/jsp/outputdatesearch.jsp"  name="opdate" method="get">
<input type="text" name="opd"><br>
