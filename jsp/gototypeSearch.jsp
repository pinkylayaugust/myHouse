...
<div class="footer">
<br>
<h2>လူၾကိီးမင္းရွာေဖြလိုေသာနာမည္ကို type ရိုက္နွိပ္ျပီးရွာေဖြနုိင္ပါသည္။</h2>
<form action="/myHouse/jsp/typeSearch.jsp"  name="tys" method="get" accept-charset="UTF-8" enctype="multipart/form-data">
<% request.setCharacterEncoding("UTF-8"); %>
<input style='font-family:Zawgyi-one;' type="text" name="tt"><br>
<input type="submit" value="Search">
</form>

</div>
<div class="bottom"><h2><center>Thank you for visiting my website</center></h2></div><div class="bottom"><h2><center>Thank you for visiting my website</center></h2></div>
</div>
</body>
</html>